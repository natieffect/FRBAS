...
class Employee(Detail,Status):
     ...
     id        = models.CharField("ID", null=True, blank=True, help_text="employee compony id")
...
class Department(Detail,Status):
     ...
     detail = models.CharField("Description",blank=True,null=True,help_text="department description")
     id     = models.CharField("ID",blank=True,null=True,help_text="department id")
     class Meta:
...
class Job(Detail,Status):
     ...
     detail     = models.CharField("Description",blank=True,null=True,help_text="job description")
     id         = models.CharField("ID",blank=True,null=True,help_text="job id")
     class Meta:
         unique_together = ('department','title', 'id')
